...
The output means: a file named `sample file name` will be changed to `sample_file_name`
...
**[red]#all deleted character will be display as red color#** ,such as `sample [red]#▯# file [red]#▯# name`

**[green]#all added character will be diplay as green color#** ,such as `sample [green]#\_# file [green]#_# name`
